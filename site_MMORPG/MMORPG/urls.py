...
from .views import (Posts, PostDetail, PostCreate, PostEdit, PostDelete, Profile, CommentCreate, Comments,
                    CommentDetail, confirm_comment, reject_comment)


urlpatterns = [path('', Posts.as_view(), name='posts'),
